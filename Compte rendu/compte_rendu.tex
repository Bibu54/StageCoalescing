...
\bpar{C'est exagéré \dots{} c'est un véhicle pour décrire un phénomène qui apparaît dans les preuves TLA+.}
...
\raph{Forme : Mettre un interligne plus grand entre deux paragraphes \stephan{(non)}}
